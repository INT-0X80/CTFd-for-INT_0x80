...
with open(os.path.join(os.path.dirname(__file__), '.ctfd_secret_key'), 'a+b') as secret:
...
class Config(object):
    ...
    '''
    SQLALCHEMY_DATABASE_URI = 'sqlite:///{}/ctfd.db'.format(os.path.dirname(os.path.abspath(__file__)))
    ...
    '''
    MAILFROM_ADDR = "noreply@int0x80.in"
